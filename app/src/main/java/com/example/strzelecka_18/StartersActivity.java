...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                new Dish("Potato and bacon skewers", "Bamboo skewers loaded with baby new potato and back bacon", 1899),
                new Dish("Italian seasoning and cornmeal salad", "Italian seasoning and cornmeal served on a bed of lettuce", 1499),
